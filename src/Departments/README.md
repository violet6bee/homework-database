...
2. Создадим таблицы, запустив скрипт из файла src/Departments/create_tables.sql.
3. Наполним таблицы данными с помощью скрипта src/Departments/insert_data.sql.
...
Решение:
Размещено в скрипте src/Departments/task1.sql.
...
Решение:
Размещено в скрипте src/Departments/task2.sql.
...
Решение:
Размещено в скрипте src/Departments/task3.sql.
