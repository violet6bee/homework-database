...
1. Создадим БД races.
2. Создадим таблицы, запустив скрипт из файла src/Races/create_tables.sql.
3. Наполним таблицы данными с помощью скрипта src/Races/insert_data.sql.
...
Решение:
Размещено в скрипте src/Races/task1.sql.
...
Решение:
Размещено в скрипте src/Races/task2.sql.
...
Решение:
Размещено в скрипте src/Races/task3.sql.
...
Решение:
Размещено в скрипте src/Races/task4.sql.
...
Решение:
Размещено в скрипте src/Races/task5.sql.
